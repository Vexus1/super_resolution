...
% \begin{figure}[h]
% \centering
% \includegraphics[width=.95\linewidth]{sr_comparison_bird.pdf}%%% <--- wstaw własny kolaż
% \caption{Fragment obrazu \emph{Bird} (Set5,~$\times2$).  
%    Wariant~9-3-5 lepiej odzyskuje pióra, bez nadmiernego wyostrzania.
%    Różnica PSNR dla samego cropa: \SI{1.4}{dB}.}
% \label{fig:vis_bird}
% \end{figure}
